...
//       // assuming res.data has a property userId
...
//       {orders.length === 0 ? (
//         <p className="text-center text-sky-500">No orders found.</p>
//       ) : (
...
//                 <p><strong>Name:</strong> {order.name || order.customer?.fullName}</p>
//                 <p><strong>Phone:</strong> {order.phone || order.customer?.phone}</p>
//                 <p><strong>Payment:</strong> {order.payment || order.customer?.paymentMethod}</p>
...
//           <div className="bg-white p-6 rounded-xl w-[90%] max-w-2xl relative shadow-xl">
//             <button
//               onClick={closeModal}
...
//               <p><strong>Name:</strong> {selectedOrder.name || selectedOrder.customer?.fullName}</p>
//               <p><strong>Phone:</strong> {selectedOrder.phone || selectedOrder.customer?.phone}</p>
//               <p><strong>Address:</strong> {selectedOrder.address || selectedOrder.customer?.address}</p>
//               <p><strong>Payment:</strong> {selectedOrder.payment || selectedOrder.customer?.paymentMethod}</p>
...
//                   <div
//                     key={i}
//                     className="flex gap-3 mb-3 items-center border-b pb-2"
//                   >
//                     <img
//                       src={item.image}
//                       alt={item.name}
...
//                 <div className="flex gap-3 mb-3 items-center border-b pb-2">
//                   <img
...
//             {selectedOrder.total && (
//               <p className="mt-3 font-bold text-lg text-right">
