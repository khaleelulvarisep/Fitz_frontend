...
//   return (
//     <div className="h-[90vh] flex flex-col bg-gray-50 rounded-xl shadow overflow-hidden p-4">
     
//       <h2 className="text-2xl font-bold text-sky-800 mb-4">Manage Users</h2>
...
//         <main className="flex-1 p-6 overflow-y-auto bg-gradient-to-br from-white to-sky-50">
//           {!selectedUser ? (
...
//                       selectedUser.isBlock ? "text-red-600" : "text-green-600"
//                     }`}
//                   >
